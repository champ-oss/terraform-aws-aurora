resource "aws_db_cluster_snapshot" "this" {
  ...
  db_cluster_snapshot_identifier = var.custom_db_cluster_snapshot_identifier != null ? var.custom_db_cluster_snapshot_identifier : substr("${aws_rds_cluster.this[0].id}-snapshot", 0, 63)
